package com.liuencier.security.core.validate.code.impl;

import com.liuencier.security.core.validate.code.*;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
    ...
    public void validate(ServletWebRequest request) throws ValidateCodeException {
        ...
        if (StringUtils.isBlank(codeInRequest)){
            throw new ValidateCodeException(processorType + "验证码的值不能位空");
        }
